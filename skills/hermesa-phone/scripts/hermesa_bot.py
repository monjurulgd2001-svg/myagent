...
def _cfg(name: str, default: str = "") -> str:
    """Read config from the environment, falling back to ~/.hermes/.env."""
...
BOT_ID = _cfg("HERMESA_BOT_ID", "PASTE_YOUR_BOT_ID_HERE")
DATABASE_URL = _cfg("HERMESA_DB_URL",
                    "https://softizence-default-rtdb.firebaseio.com").rstrip("/")
