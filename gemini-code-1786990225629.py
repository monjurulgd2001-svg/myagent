...
# [FIX] সার্ভার এরর দিলে এখন ৫ বার পর্যন্ত রি-ট্রাই করবে
_retries = 5 
...
class GitHub:
    ...
    def _req(self, method, path, body=None):
        ...
        for attempt in range(_retries):
            # [FIX] রি-ট্রাই করার সময় প্রতিবার নতুন করে Request তৈরি করা হচ্ছে
            ...
            try:
                # [FIX] টাইমআউট ৬০ থেকে ১২০ সেকেন্ড করা হলো বড় ফাইলের জন্য
                ...
                # 503 এরর পেলে আরো বেশি সময় অপেক্ষা করে আবার চেষ্টা করবে
    ...
    def _push_worker(self, c, files):
        try:
            ...
            for i, (rel, ap) in enumerate(files, 1):
                ...
                # ফাইলের সাইজ বের করা হচ্ছে
                size_mb = len(data) / (1024 * 1024)
                if size_mb > 15:
                    self.emit("সতর্কতা: %s ফাইলের সাইজ অনেক বড় (%.1f MB)। API-তে সমস্যা হতে পারে।" % (rel, size_mb))
                ...
                # লগে ফাইলের সাইজ (KB তে) দেখানো হবে
                self.emit("  + %s (%.1f KB)" % (rel, len(data) / 1024))
                self.set_progress(i, total + 3)
                
                # [FIX] Rate Limiting থেকে বাঁচার জন্য একটু বেশি সময় (১.৫ সেকেন্ড) বিরতি
                time.sleep(1.5)
